...
val repositoryModule = module {
    single { NasaApiService(provideHttpClient()) }
    single { NasaRoverPhotosRepositoryImpl(get()) }

//    single { OssigApiService(provideHttpClient()) }
//    single { OssigAuthRepositoryImpl(get()) }
//    single { OssigCarrierRepositoryImpl(get()) }
